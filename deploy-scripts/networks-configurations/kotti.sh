...
export DEPLOY_DIR=`pwd`/kotti-deploy
mkdir -p $DEPLOY_DIR

#development, rinkeby, mainnet
# forked network is still 'development'
#export NETWORK='development'
export NETWORK='kotti'
export RELAY_HOST="kotti1-220.relays.opengsn.org"

export NODEURL=https://kotti.connect.bloq.cloud/v1/roast-blossom-sentence
...
export MNEMONIC_FILE=~/.secret/testnet-mnemonic.txt
